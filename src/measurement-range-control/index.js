...
export default function MeasureRangeControl({
	...
	return [
		onChange && (
			<div
				className={`components-base-control component-spacing-sizes-control kadence-measure-range-control ${
					className ? ' ' + className : ''
				}`}
			>
				{label && (
					<Flex justify="space-between" className={'kadence-component__header kadence-radio-range__header'}>
						{label && (
