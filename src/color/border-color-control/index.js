...
export default function BorderColorControls({
	...
	return (
		<div
			ref={containerRef}
			className={`components-base-control kb-border-color-control ${'' !== className ? ' ' + className : ''}`}
		>
				...
				{realControl === 'individual' && (
					<div className="kt-border-color-array-control">
						<PopColorControl
							...
							default2={defaultColor2 ? defaultColor2 : ''}
							onChange2={
								onChange2 ? (update) => onChange2([update, value2[1], value2[2], value2[3]]) : undefined
							}
							value3={value3 && value3[0] ? value3[0] : ''}
							swatchLabel3={swatchLabel3 ? swatchLabel3 : ''}
							default3={defaultColor3 ? defaultColor3 : ''}
							onChange3={
								onChange3 ? (update) => onChange3([update, value3[1], value3[2], value3[3]]) : undefined
							}
						/>
						<PopColorControl
							label={secondIcon}
							...
							default2={defaultColor2 ? defaultColor2 : ''}
							onChange2={
								onChange2 ? (update) => onChange2([value2[0], update, value2[2], value2[3]]) : undefined
							}
							value3={value3 && value3[1] ? value3[1] : ''}
							swatchLabel3={swatchLabel3 ? swatchLabel3 : ''}
							default3={defaultColor3 ? defaultColor3 : ''}
							onChange3={
								onChange3 ? (update) => onChange3([value3[0], update, value3[2], value3[3]]) : undefined
							}
						/>
						<PopColorControl
							label={thirdIcon}
							...
							default2={defaultColor2 ? defaultColor2 : ''}
							onChange2={
								onChange2 ? (update) => onChange2([value2[0], value2[1], update, value2[3]]) : undefined
							}
							value3={value3 && value3[2] ? value3[2] : ''}
							swatchLabel3={swatchLabel3 ? swatchLabel3 : ''}
							default3={defaultColor3 ? defaultColor3 : ''}
							onChange3={
								onChange3 ? (update) => onChange3([value3[0], value3[1], update, value3[3]]) : undefined
							}
						/>
						<PopColorControl
							label={fourthIcon}
							...
							default2={defaultColor2 ? defaultColor2 : ''}
							onChange2={
								onChange2 ? (update) => onChange2([value2[0], value2[1], value2[2], update]) : undefined
							}
							value3={value3 && value3[3] ? value3[3] : ''}
							swatchLabel3={swatchLabel3 ? swatchLabel3 : ''}
							default3={defaultColor3 ? defaultColor3 : ''}
							onChange3={
								onChange3 ? (update) => onChange3([value3[0], value3[1], value3[2], update]) : undefined
							}
						/>
					</div>
				)}
