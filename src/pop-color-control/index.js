				...
				<div className="kadence-pop-color-container">
					...
					<div className="kadence-pop-color-popovers">
						<SinglePopColorControl
							...
							onOpacityChange={
								this.props.onOpacityChange ? (value) => this.props.onOpacityChange(value) : undefined
							}
							onArrayChange={
								this.props.onArrayChange
									? (value, opacity) => this.props.onArrayChange(value, opacity)
									: undefined
							}
							onClassChange={
							...
							<SinglePopColorControl
								...
								onOpacityChange={
									this.props.onOpacityChange2
										? (value) => this.props.onOpacityChange2(value)
										: undefined
								}
								onArrayChange={
									this.props.onArrayChange2
										? (value, opacity) => this.props.onArrayChange2(value, opacity)
										: undefined
								}
								onClassChange={
									this.props.onClassChange2 ? (value) => this.props.onClassChange2(value) : undefined
								}
								value={valueColor2}
						...
						{onChange3 && (
							<SinglePopColorControl
								...
								onOpacityChange={
									this.props.onOpacityChange3
										? (value) => this.props.onOpacityChange3(value)
										: undefined
								}
								onArrayChange={
									this.props.onArrayChange3
										? (value, opacity) => this.props.onArrayChange3(value, opacity)
										: undefined
								}
								onClassChange={
									this.props.onClassChange3 ? (value) => this.props.onClassChange3(value) : undefined
								}
								value={valueColor3}
