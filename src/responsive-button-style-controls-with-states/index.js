...
export default function ResponsiveButtonStyleControlsWithStates( {
	colorBase = 'color',
	colorLabel = __( 'Color', '__KADENCE__TEXT__DOMAIN__' ),
	backgroundBase = '',
	backgroundLabel = __( 'Background', '__KADENCE__TEXT__DOMAIN__' ),
	backgroundTypeBase = '',
	backgroundTypeLabel = __( 'Type', '__KADENCE__TEXT__DOMAIN__' ),
	backgroundGradientBase = '',
	backgroundGradientLabel = __( 'Gradient', '__KADENCE__TEXT__DOMAIN__' ),
	borderBase = '',
	borderLabel = __( 'Border', '__KADENCE__TEXT__DOMAIN__' ),
	borderRadiusBase = '',
	borderRadiusUnitBase = '',
	borderRadiusLabel = __( 'Border Radius', '__KADENCE__TEXT__DOMAIN__' ),
	shadowBase = '',
	shadowLabel = __( 'Box Shadow', '__KADENCE__TEXT__DOMAIN__' ),
	includeActive = true,
	setAttributes,
	setMetaAttribute,
	attributes,
			...
			{ shadowBase && (
				<BoxShadowControl
					...
					enable={
						...
						undefined !== shadowValue[ 0 ].enable
					...
					spread={
						undefined !== shadowValue &&
						undefined !== shadowValue[ 0 ] &&
						undefined !== shadowValue[ 0 ].spread
