...
class URLExtenalInputControl extends Component {
   ...
   render() {
       ...
       return (
           <div className={ `components-base-control kb-side-link-external kb-side-link-control${ dynamicAttribute && kadence_blocks_params.dynamic_enabled ? ' has-dynamic-support' : '' }` }>
               { label && (
                       ...
                       <BaseControl className={ 'kb-search-selection-name' }>
                           <div className="kb-search-url-input">
                               <input
                                   ...
                                   className={ `kb-external-link-input${ allowClear && value ? ' link-input-has-clear' : '' }` }
                                   type={ 'text' }
