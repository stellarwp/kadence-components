...
import { Dashicon, Button, ButtonGroup, DropdownMenu } from '@wordpress/components';
/**
	...
	return [
		onChange && onChangeTablet && onChangeMobile && (
			<div ref={ref} className={'components-base-control kb-responsive-unit-control kadence-unit-control'}>
				<div className={'kadence-unit-control__header kadence-component__header'}>
					{label && (
					...
					{!compressedDevice && (
						...
						>
							{map(devices, ({ name, key, title, itemClass }) => (
								<Button
									key={key}
									className={`kb-responsive-btn ${itemClass}${
